...
def aoc_in(day: str) -> Tuple[str]:
    ...
    the stem of the filename. (4b.py == 4.py == 4)
    Returns tuple of two file strings: the first for example data
    (or empty string) and the second for the real data (or empty) for the
    corresponding day in data subdirectory."""
